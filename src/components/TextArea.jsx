      ...
      <div style={{ position: 'relative' }}>
        <textarea
          ...
          style={{
            ...
            border: isFocused ? '2px solid rgba(96, 165, 250, 0.5)' : '2px solid rgba(255, 255, 255, 0.1)',
            color: 'white',
            ...
            boxShadow: isFocused ? '0 10px 25px -5px rgba(96, 165, 250, 0.2)' : '0 4px 6px -1px rgba(0, 0, 0, 0.1)',
        ...
        <div 
          style={{
            ...
            color: (value || isFocused) ? 'rgba(147, 197, 253, 0.8)' : 'rgba(255, 255, 255, 0.5)',
          ...
          >
            <div 
              style={{
                ...
                background: value.length > maxLength * 0.9 ? '#f87171' :
                           value.length > maxLength * 0.75 ? '#fbbf24' :
                           '#60a5fa'
              }}
            />
          </div>
