...
const MindClear = () => {
  ...
  const { isPlaying: isMusicPlaying, toggleMusic, changeTrack } = useMusicPlayer();
  ...
  const getBackgroundStyle = () => {
    if (analysis && analysis.emotion) {
      ...
      switch(analysis.emotion) {
        case 'cemas':
          return {
            background: 'linear-gradient(135deg, #667eea 0%, #764ba2 30%, #8338ec 70%, #3a0ca3 100%)'
          };
        case 'stres':
          return {
            background: 'linear-gradient(135deg, #ff006e 0%, #ff4081 30%, #e91e63 70%, #ad1457 100%)'
          };
        case 'sedih':
          return {
        ...
        case 'marah':
          return {
            background: 'linear-gradient(135deg, #ff006e 0%, #ff4081 30%, #ff6b6b 70%, #ee5a24 100%)'
          };
        case 'bahagia':
          return {
        ...
        default:
          return {
            background: 'linear-gradient(135deg, #667eea 0%, #764ba2 50%, #8338ec 100%)'
          };
      }
    }
    return {
        ...
        <div style={{ 
          ...
          >
            ...
            <div style={{ position: 'relative', zIndex: 10 }}>
              ...
              >
                "sometimes you just need a space to dump everything out — no judgment, no pressure. this is that place ✨"
              </p>
            </div>
            ...
            <div style={{ gap: '2rem', position: 'relative', zIndex: 10 }}>
              ...
              >
                <button
                  ...
                  style={{
                    ...
                    transform: userText.trim() ? 'translateY(-2px) scale(1.02)' : 'none',
                    minWidth: '160px'
                  }}
                  onMouseEnter={(e) => {
                    if (userText.trim()) {
                      e.target.style.transform = 'translateY(-4px) scale(1.05)';
                      e.target.style.boxShadow = '0 15px 40px rgba(102, 126, 234, 0.4), 0 0 0 1px rgba(255, 255, 255, 0.2)';
                    }
                  }}
                  onMouseLeave={(e) => {
                    if (userText.trim()) {
                      e.target.style.transform = 'translateY(-2px) scale(1.02)';
                      e.target.style.boxShadow = '0 10px 30px rgba(102, 126, 234, 0.3), 0 0 0 1px rgba(255, 255, 255, 0.1)';
                    }
                  }}
                >
                  <span style={{ 
                ...
                <div style={{
                  ...
                  >
                    <span style={{ 
                      ...
                      <span style={{ fontSize: '1.125rem' }}>{isMusicPlaying ? "🔇" : "🎵"}</span>
                      <span>vibes</span>
                    </span>
                  </button>
                  ...
                  {isMusicPlaying && (
                    <div style={{
                      ...
                      <div style={{
                        ...
                        {[
                          { key: 'lofi', emoji: '🌙', name: 'Lofi', desc: 'Chill' },
                          { key: 'nature', emoji: '🌿', name: 'Nature', desc: 'Fresh' },
                          { key: 'focus', emoji: '🧘', name: 'Focus', desc: 'Deep' },
                          { key: 'rain', emoji: '🌧️', name: 'Rain', desc: 'Cozy' }
                        ].map((track) => (
                          <button
                            key={track.key}
                            onClick={() => {
                          ...
                          >
                            ...
                            <div>
                              ...
                              <div style={{ fontSize: '0.6rem', opacity: 0.7 }}>{track.desc}</div>
                            </div>
                          </button>
                        ))}
                      </div>
              ...
              >
                ...
                >
                  ...
                  <div style={{ fontSize: '0.875rem', color: 'rgba(255,255,255,0.8)' }}>100% private</div>
                </div>
                <div 
                  style={{
                    textAlign: 'center',
                ...
                >
                  <div style={{ fontSize: '1.5rem', marginBottom: '0.5rem' }}>🤖</div>
                  <div style={{ fontSize: '0.875rem', color: 'rgba(255,255,255,0.8)' }}>AI powered</div>
                </div>
                <div 
                  style={{
                    textAlign: 'center',
                ...
                >
                  <div style={{ fontSize: '1.5rem', marginBottom: '0.5rem' }}>💙</div>
                  <div style={{ fontSize: '0.875rem', color: 'rgba(255,255,255,0.8)' }}>judgment free</div>
                </div>
              </div>
            </div>
        ...
        >
          <div style={{ textAlign: 'center', marginBottom: '2rem', position: 'relative', zIndex: 10 }}>
            ...
            >
              ...
              ></div>
              <span className="text-sm text-green-400 font-medium">completely private</span>
            </div>
            
            <p className="text-lg text-white/90 max-w-2xl mx-auto">
              take your time, literally nobody's gonna judge you here. this is YOUR moment 🌟
            </p>
          </div>
          ...
          <div className="space-y-8 relative z-10">
            ...
            <div style={{ 
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  if (userText.trim()) {
                    e.target.style.transform = 'translateY(-4px) scale(1.05)';
                    e.target.style.boxShadow = '0 18px 50px rgba(16, 185, 129, 0.4), 0 0 0 1px rgba(255, 255, 255, 0.2)';
                  }
                }}
                onMouseLeave={(e) => {
                  if (userText.trim()) {
                    e.target.style.transform = 'translateY(-2px) scale(1.02)';
                    e.target.style.boxShadow = '0 12px 35px rgba(16, 185, 129, 0.3), 0 0 0 1px rgba(255, 255, 255, 0.1)';
                  }
                }}
              >
                <span style={{ 
            ...
            <div className="text-center">
              <p className="text-sm text-white/60">
                {userText.length < 50 ? "just start typing, even random thoughts count 💭" :
                 userText.length < 200 ? "you're doing great, keep going if you want 🌱" :
      ...
      >
        ...
        >
          <div style={{ position: 'relative', zIndex: 10 }}>
            ...
            >
              <span style={{ fontSize: '1.875rem', animation: 'pulse 2s infinite' }}>🤖</span>
            </div>
  ...
  if (currentStep === "result") {
    return (
      ...
      >
        <div style={{ maxWidth: '32rem', margin: '0 auto', textAlign: 'center', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
