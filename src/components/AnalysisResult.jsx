        ...
        <div style={{ textAlign: 'center' }}>
          <button
            ...
            style={{
              ...
              transform: isBurning ? 'scale(0.95)' : 'translateY(-2px) scale(1.02)',
              minWidth: '220px'
            }}
            onMouseEnter={(e) => {
              if (!isBurning) {
                e.target.style.transform = 'translateY(-4px) scale(1.05)';
                e.target.style.boxShadow = '0 18px 50px rgba(239, 68, 68, 0.4), 0 0 0 1px rgba(255, 255, 255, 0.2)';
              }
            }}
            onMouseLeave={(e) => {
              if (!isBurning) {
                e.target.style.transform = 'translateY(-2px) scale(1.02)';
                e.target.style.boxShadow = '0 12px 35px rgba(239, 68, 68, 0.3), 0 0 0 1px rgba(255, 255, 255, 0.1)';
              }
            }}
          >
            <span style={{ 
